 ...
 * @Description:
 */
public class OrderlyImageView extends ToolbarToggleImageView {

    public OrderlyImageView(Context context) {
        super(context);
        setFormat(Format.ORDERED);
        setWhitelistValues(new Object[]{true, false});
        setNormalState(R.drawable.ic_format_orderly);
