 ...
 * @Description:
 */
public class UnorderedImageView extends ToolbarToggleImageView {

    public UnorderedImageView(Context context) {
        super(context);
        setFormat(Format.BULLET);
        setWhitelistValues(new Object[]{true, false});
        setNormalState(R.drawable.ic_format_unordered);
